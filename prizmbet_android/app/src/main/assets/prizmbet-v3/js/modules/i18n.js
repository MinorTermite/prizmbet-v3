...
const DICTIONARY = {
    ru: {
        ...
        'hero.trustOddsTitle': 'Фиксированный коэффициент',
        'hero.trustOddsCopy': 'Купон удерживает коэффициент, пока код остаётся активным.',
        ...
        'hero.trustPayoutCopy': 'Корректные выигрышные ставки обрабатываются по правилам проекта.',
        ...
        'quick.step2Copy': 'Укажите кошелёк и сумму. Купон зафиксирует параметры ставки.',
        'quick.step3Title': 'Проверьте статус',
        'quick.step3Copy': 'После перевода откройте кабинет и отслеживайте принятие и расчёт.',
        'quick.note': 'Купон связывает событие, исход, коэффициент, сумму и кошелёк. Этот набор система проверяет при обработке ставки.',
        ...
        'rules.copy': 'Здесь оставлены только ключевые проверки, которые влияют на принятие ставки.',
        ...
        'rules.limitsCopy': 'Ставки вне лимитов или с неверным кодом исключаются из расчёта.',
        'rules.min': 'Мин: 1 500 PRIZM',
        'rules.max': 'Макс: 200 000 PRIZM',
        'rules.payout': 'Выплаты до 24 часов',
        'footer.copy': 'Информационный сервис по спортивным событиям. Сайт отображает линию, статусы и данные по ставкам внутри экосистемы проекта.',
        'toast.brand': 'PRIZMBET',
        'coupon.title': 'Умный купон',
        'coupon.wallet': 'Кошелёк игрока',
        'coupon.amount': 'Сумма ставки',
        ...
        'coupon.issue': 'Выпустить код ставки',
