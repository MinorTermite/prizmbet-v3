...
const DICTIONARY = {
    ru: {
        ...
        'hero.trustOddsCopy': 'Сумма ставки × коэффициент = ожидаемая выплата по купону.',
        ...
        'quick.step2Copy': 'Укажите кошелёк и сумму. Купон зафиксирует параметры и покажет будущую выплату.',
        ...
        'rules.copy': 'Здесь собраны только ключевые проверки prematch-ставки и перевода.',
        ...
        'rules.limitsCopy': 'Публичная версия принимает только prematch-ставки в лимитах и с корректным кодом.',
    ...
    en: {
        ...
        'hero.trustOddsCopy': 'Bet amount × odds = the expected payout locked in the coupon.',
        ...
        'rules.limitsCopy': 'The public version accepts prematch bets only, within limits and with a valid code.',
