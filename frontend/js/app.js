/**
 * 1PrizmBet - Main Entry Point
 */
import * as utils from './modules/utils.js';
import * as filters from './modules/filters.js';
import * as storage from './modules/storage.js';
import * as notif from './modules/notifications.js';
import * as betSlip from './modules/bet_slip.js?v=20260508-mobile-operator-notify-v77';
import * as historyUI from './modules/history_ui.js?v=20260508-mobile-operator-notify-v77';
...
function updateApp(newMatches) {
    ...
    ui.updateLineCounter(displayMatches, allMatches);
...
function scrollToLine() {
    const target = document.querySelector('.search-container') || document.getElementById('content');
    if (!target) return;
